                ...
                <Grid container spacing={3}>
                    <Grid item xs={4}>
                        <Item>
                            <div className="car_item">
                                <div >
                                    <img className="car_img" src="https://cdn.jarviscars.com.au//img/news/toyota/toyota-prado.jpg"></img>
                                </div>
                    ...
                    <Grid item xs={4}>
                        <Item>
                            <div className="car_item">
                                <div >
                                    <img className="car_img" src="https://us.123rf.com/450wm/whitecity/whitecity2107/whitecity210700522/whitecity210700522.jpg?ver=6"></img>
                                </div>
                    ...
                    <Grid item xs={4}>
                        <Item>
                            <div className="car_item">
                                <div >
                                    <img className="car_img" src="https://s3.us-east-2.amazonaws.com/dealer-inspire-vps-vehicle-images/11000623/JTDKAMFU4N3188731/dffef90d727480b574f62001f5d79f85.jpg"></img>
                                </div>
                                <div>
                                    <h4 className="section_title">Toyota Aventador</h4>
                                    <h6 className="priceDate">$40.00<span>/ Day</span></h6>
